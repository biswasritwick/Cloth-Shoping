...
export class AdminNavbarComponent {
 ...
 /* public afterLogin() {
    ...
    let localStorageValueType = localStorage.getItem('userType')

    if (localStorageValue! && localStorageValueType) {
      if (localStorage.getItem('employe')) {
        if (localStorage.getItem('employe') && localStorageValueType == 'service') {
          console.warn('permission service', true);
          this.menuType = 'default'

        } else if (localStorage.getItem('employe') && localStorageValueType == 'telecaller') {
          console.warn('permission telecaller', true);
          this.menuType = 'telecaller'
